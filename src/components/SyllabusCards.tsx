                    ...
                    {syllabus.map((topic, index) => {
                        ...
                        return (
                            <FadeIn
                                ...
                                as={Card}
                                delay={index * 100}
                                className="group relative overflow-hidden border-border/50 bg-card/50 transition-all hover:-translate-y-1 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5"
                            >
